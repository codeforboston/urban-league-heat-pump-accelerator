// TODO: temporary to avoid modifying backend's example data
module.exports = [
  {
    id: 1,
    ...
    survey_questions: [
      ...
      },
      {
        ...
        response_type: "radio",
        response_options: ["Oil", "Gas", "Electric (for baseboard)", "Other"],
      },
      {
        id: 13,
        display_order: 13,
  ...
  },
  {
    ...
    survey_questions: [
      ...
      },
      {
        id: 18,
        display_order: 18,
        text: "Did you speak to the homeowner?",
        response_type: "radio",
        response_options: ["Yes", "No"],
      },
      {
