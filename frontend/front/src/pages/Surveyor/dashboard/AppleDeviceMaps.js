...
export function AppleDeviceMaps(props){
    ...
    return (
        <div>
            <Button variant="contained"  onClick={handleOpen} disabled={props.checked.length===0}>
                GENERATE ROUTE
            </Button>
            <Modal
                open={open}
            ...
            >
                <Box sx={style}>
                    ...
                    <Box
                        ...
                        gap="16px"
                    >
                        <Button size="large" variant="contained" onClick={handleAppleMapsBtn}>
                            Apple Maps
                        </Button>
                        <Button size="large" variant="contained" onClick={handleGoogleMapsBtn}>
