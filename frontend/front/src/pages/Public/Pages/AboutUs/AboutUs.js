...
import { Box, Grid, Typography, Divider, Stack, Link } from "@mui/material";
...
function AboutUs() {
  ...
  return (
    ...
    >
      ...
      <Box>
        <Typography
          sx={theme.typography.title3}
        >
          <u>BHPA CORE PARTNERS</u>
        </Typography>
      </Box>
      <PartnerTile
